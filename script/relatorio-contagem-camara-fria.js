    ...
    const RelatorioContagemCamaraFria = {
        ...
        montarDetalhe(item, contagem) {
            ...
            return {
                ...
                caixasAvulsas: quantidades.caixasAvulsas,
                caixas: quantidades.totalCaixas,
        ...
        renderKPIs() {
            ...
            const totalCaixasAvulsas = this.resumoRows.reduce((acc, row) => acc + row.caixasAvulsas, 0);
            ...
            this.totalCaixasAvulsasPDF = totalCaixasAvulsas;
        },
