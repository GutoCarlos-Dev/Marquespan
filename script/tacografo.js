...
const TACOGRAFO_PAGE_ID = 'tacografo.html';
...
const TacografoUI = {
    ...
    async verificarPermissaoPagina() {
        ...
        try {
            ...
            if ((data?.paginas_permitidas || []).includes(TACOGRAFO_PAGE_ID)) {
                return true;
            }
        } catch (error) {
            console.error('Erro ao verificar permissao da pagina de tacografo:', error);
        }
        ...
        document.body.innerHTML = `
            <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;text-align:center;font-family:Arial,sans-serif;">
                <div>
                    ...
                    <p>Voce nao tem permissao para acessar a pagina de tacografo.</p>
